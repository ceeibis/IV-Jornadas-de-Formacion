...
%%%                                                                          %%%
%%%               --- cover.tex : PDF BOOK COVERS (PRESS) ---                %%%
%%%                                                                          %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%                                                                          %%%
...
\newlength{\coverWidth}
\setlength{\coverWidth}{\thesisWidth * 2 + \spineWidth}
                  % (170mm|6.69375inch) * 2 + 8mm = 348mm %
...
%\input{mythesis.sty} % It also executes \setpagelayout
